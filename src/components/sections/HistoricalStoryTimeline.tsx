...
const HistoricalStoryTimeline: React.FC = () => {
    ...
    const periods: Period[] = [
        ...
        },
        {
            ...
            content: "Hiến pháp năm 1992 ra đời đánh dấu bước phát triển quan trọng trong việc xây dựng nhà nước pháp quyền. Hiến pháp này khẳng định vai trò lãnh đạo của Đảng, đồng thời công nhận và bảo vệ các thành phần kinh tế khác nhau, tạo hành lang pháp lý vững chắc cho sự nghiệp đổi mới.",
            highlights: [
        ...
        },
        {
            ...
            content: "Giai đoạn này chứng kiến sự chuyển dịch cơ cấu kinh tế từ nông nghiệp sang công nghiệp và dịch vụ. Các khu công nghiệp được xây dựng, thu hút đầu tư nước ngoài. Việt Nam bắt đầu hình thành các ngành công nghiệp chế biến, xuất khẩu, tạo tiền đề cho công nghiệp hóa, hiện đại hóa.",
            highlights: [
        ...
        },
        {
            ...
            content: "Việt Nam tích cực mở rộng quan hệ đối ngoại, bình thường hóa quan hệ với nhiều nước. Chính sách đối ngoại 'Việt Nam muốn làm bạn với tất cả các nước' được triển khai mạnh mẽ. Việc gia nhập ASEAN (1995) và cải thiện quan hệ với các nước lớn mở ra cơ hội hội nhập kinh tế quốc tế.",
            highlights: [
        ...
        },
        {
            ...
            content: "Hệ thống ngân hàng được tái cơ cấu với mô hình hai cấp: Ngân hàng Nhà nước và các ngân hàng thương mại. Thị trường chứng khoán được thai nghén. Các chính sách tài chính - tiền tệ được hoàn thiện để phục vụ nền kinh tế thị trường, kiểm soát lạm phát và ổn định kinh tế vĩ mô.",
            highlights: [
        ...
        },
        {
            ...
            content: "Đầu tư cho giáo dục được đặc biệt chú trọng nhằm nâng cao chất lượng nguồn nhân lực. Chương trình giáo dục được đổi mới, chuyển từ 'truyền thụ' sang 'phát triển năng lực'. Các trường đại học mở rộng, chất lượng đào tạo được cải thiện để đáp ứng yêu cầu phát triển kinh tế - xã hội.",
            highlights: [
        ...
        },
        {
            ...
            content: "Chương trình xóa đói giảm nghèo được triển khai đồng bộ trên cả nước. Nhờ tăng trưởng kinh tế và các chính sách xã hội phù hợp, tỷ lệ hộ nghèo giảm mạnh. Đời sống nhân dân được cải thiện đáng kể, an sinh xã hội được chú trọng, thể hiện bản chất nhân văn của chế độ.",
            highlights: [
        ...
        },
        {
            ...
            content: "Ngày 28/7/1995, Việt Nam chính thức trở thành thành viên thứ 7 của ASEAN, đánh dấu bước ngoặt lịch sử trong chính sách đối ngoại. Việc gia nhập ASEAN mở ra cơ hội hội nhập kinh tế khu vực, tăng cường hợp tác chính trị, an ninh và văn hóa, nâng cao vị thế Việt Nam trên trường quốc tế.",
            highlights: [
        ...
        },
        {
            ...
            content: "Việc bình thường hóa quan hệ Việt Nam - Hoa Kỳ mở ra trang mới trong quan hệ đối ngoại. Dù còn nhiều khác biệt, hai nước cam kết phát triển quan hệ trên cơ sở tôn trọng độc lập, chủ quyền và lợi ích của nhau. Điều này tạo môi trường thuận lợi cho hợp tác kinh tế, thương mại.",
            highlights: [
        ...
        },
        {
            ...
            content: "Đầu tư phát triển hạ tầng kinh tế - xã hội được đẩy mạnh. Các tuyến đường giao thông, cầu cống, hệ thống điện, nước được nâng cấp và xây dựng mới. Hạ tầng viễn thông bắt đầu hiện đại hóa. Việc cải thiện hạ tầng tạo điều kiện thuận lợi cho phát triển kinh tế và nâng cao đời sống người dân.",
            highlights: [
        ...
        },
        {
            ...
            content: "Từ một nước nhập khẩu lương thực, Việt Nam trở thành nước xuất khẩu gạo lớn thứ 2 thế giới. Thành công này là kết quả của cải cách nông nghiệp, chính sách khuyến khích sản xuất và cải thiện kỹ thuật canh tác. Đây là minh chứng sinh động cho sự thành công của chính sách đổi mới.",
            highlights: [
        ...
        },
        {
            ...
            content: "Internet bắt đầu du nhập vào Việt Nam, mở ra kỷ nguyên số. Các doanh nghiệp công nghệ thông tin đầu tiên được thành lập. Chính phủ nhận thức được tầm quan trọng của công nghệ thông tin trong phát triển kinh tế - xã hội và bắt đầu xây dựng chiến lược phát triển ngành này.",
            highlights: [
        ...
        },
        {
            ...
            content: "Ngành du lịch được xác định là ngành kinh tế mũi nhọn. Các di sản văn hóa, thiên nhiên được bảo tồn và khai thác. Hạ tầng du lịch được đầu tư, dịch vụ du lịch được nâng cao. Việt Nam bắt đầu thu hút du khách quốc tế, mở ra nguồn thu ngoại tệ quan trọng và giới thiệu đất nước với bạn bè thế giới.",
            highlights: [
        ...
        },
        {
            ...
            content: "Hệ thống y tế được củng cố và mở rộng, đặc biệt ở vùng nông thôn, miền núi. Chương trình y tế cơ sở được tăng cường. Các chỉ số sức khỏe cộng đồng được cải thiện: tuổi thọ trung bình tăng, tỷ lệ tử vong trẻ em giảm. Đây là thành tựu quan trọng về bảo vệ và chăm sóc sức khỏe nhân dân.",
            highlights: [
        ...
        },
        {
            ...
            content: "Hoạt động văn hóa, văn nghệ được đổi mới, phong phú hơn. Các giá trị văn hóa truyền thống được bảo tồn và phát huy. Thể thao quần chúng và thể thao thành tích đều được chú trọng. Việt Nam đạt nhiều thành tích cao tại các giải thể thao khu vực và quốc tế, nâng cao tinh thần dân tộc.",
            highlights: [
        ...
        },
        {
            ...
            content: "Ý thức bảo vệ môi trường bắt đầu được nâng cao. Các chính sách về môi trường được ban hành. Mô hình phát triển bền vững được quan tâm, cân bằng giữa phát triển kinh tế và bảo vệ môi trường. Các khu bảo tồn thiên nhiên được thành lập, tài nguyên rừng được quản lý tốt hơn.",
            highlights: [
        ...
        },
        {
            ...
            content: "Chính sách dân số - kế hoạch hóa gia đình được triển khai mạnh mẽ nhằm kiểm soát tốc độ tăng dân số, nâng cao chất lượng cuộc sống. Chương trình 'Một hoặc hai con là đủ' được tuyên truyền sâu rộng. Việc kiểm soát dân số góp phần quan trọng vào phát triển kinh tế - xã hội bền vững.",
            highlights: [
    ...
    return (
        <section ref={timelineRef} className="py-20 bg-gradient-to-br from-red-50 via-yellow-50 to-white">
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Khám phá 19 giai đoạn lịch sử quan trọng của Việt Nam trong thời kỳ đổi mới. 
                        Nhấp vào từng hình ảnh để khám phá câu chuyện và xem phiên bản màu đặc biệt.
                    </p>
                </div>

                {/* Period Grid */}
                <div ref={ref} className="period-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-7xl mx-auto">
                                    ...
                                    <div className="relative bg-gray-100 flex items-center justify-center p-6">
                                        <div className="relative w-full max-h-[70vh]">
                                            <motion.img
                                                ...
                                                src={showColoredImage && periods[currentPeriod].coloredImage 
                                    ...
                                    <div className="p-8 overflow-y-auto">
                                        ...
                                        <div className="prose prose-lg max-w-none">
                                            ...
                                            <ul className="space-y-3">
                                                {periods[currentPeriod].highlights.map((highlight, idx) => (
                                        ...
                                        <div className="mt-8 pt-6 border-t border-gray-200">
                                            <div className="flex items-center justify-between text-sm text-gray-600 mb-2">
                                                <span>Tiến độ</span>
                                                <span className="font-semibold">{currentPeriod + 1} / {periods.length}</span>
                                            </div>
                                            <div className="w-full bg-gray-200 rounded-full h-2">
                                                <div 
                                                    className="bg-gradient-to-r from-red-600 to-yellow-600 h-2 rounded-full transition-all duration-300"
                                                    style={{ width: `${((currentPeriod + 1) / periods.length) * 100}%` }}
                                                />
                                            </div>
                                        </div>
                                    </div>
